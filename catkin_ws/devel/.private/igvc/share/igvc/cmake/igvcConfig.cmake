...
if("TRUE" STREQUAL "TRUE")
  set(igvc_SOURCE_PREFIX /home/lab3/IGVC/catkin_ws/src/igvc)
  set(igvc_DEVEL_PREFIX /home/lab3/IGVC/catkin_ws/devel/.private/igvc)
  set(igvc_INSTALL_PREFIX "")
  set(igvc_PREFIX ${igvc_DEVEL_PREFIX})
else()
  set(igvc_SOURCE_PREFIX "")
  set(igvc_DEVEL_PREFIX "")
  set(igvc_INSTALL_PREFIX /home/lab3/IGVC/catkin_ws/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'igvc' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/lab3/IGVC/catkin_ws/src/igvc/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/lab3/IGVC/catkin_ws/devel/.private/igvc/lib;/home/lab3/IGVC/catkin_ws/devel/lib;/home/lab3/catkin_ws/devel/lib;/opt/ros/noetic/lib)
