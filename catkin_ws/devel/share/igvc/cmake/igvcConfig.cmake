...
if("TRUE" STREQUAL "TRUE")
  set(igvc_SOURCE_PREFIX /Users/zu/catkin_ws/src/igvc)
  set(igvc_DEVEL_PREFIX /Users/zu/catkin_ws/devel)
  set(igvc_INSTALL_PREFIX "")
  set(igvc_PREFIX ${igvc_DEVEL_PREFIX})
else()
  set(igvc_SOURCE_PREFIX "")
  set(igvc_DEVEL_PREFIX "")
  set(igvc_INSTALL_PREFIX /Users/zu/catkin_ws/install)
...
if(NOT " " STREQUAL " ")
  ...
  elseif(NOT " " STREQUAL " ")
    ...
    set(_report "Report the problem to the maintainer 'zu <zu@todo.todo>' and request to fix the problem.")
  endif()
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'igvc' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/Users/zu/catkin_ws/src/igvc/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /Users/zu/catkin_ws/devel/lib;/opt/miniconda3/envs/ROS/lib)
